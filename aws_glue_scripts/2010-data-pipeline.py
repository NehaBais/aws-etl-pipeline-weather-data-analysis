...
raw_data_node1701332725943 = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": ["s3://noaa-ghcn-pds/csv/by_year/2010.csv"],
        "recurse": True,
    },
...
# Script generated for node archive_change_names
archive_change_names_node1701332992771 = ApplyMapping.apply(
    ...
    transformation_ctx="archive_change_names_node1701332992771",
)

# Script generated for node filter_on_station
filter_on_station_node1701333376561 = Join.apply(
    frame1=archive_change_names_node1701332992771,
