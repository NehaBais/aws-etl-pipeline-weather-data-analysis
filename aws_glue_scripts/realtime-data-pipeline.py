...
# Script generated for node realtime_data
realtime_data_node1701332725943 = glueContext.create_dynamic_frame.from_options(
    format_options={
        "quoteChar": '"',
        "withHeader": True,
        "separator": ",",
    ...
    format="csv",
    connection_options={
        "paths": ["s3://noaa-ghcn-pds/csv/by_year/2023.csv"],
        "recurse": True,
    },
    transformation_ctx="realtime_data_node1701332725943",
)
...
filter_datatype_node1701333650075 = Filter.apply(
    frame=realtime_data_node1701332725943,
    f=lambda row: (
